...
1. Pick 2–3 items that clearly became big in the past month by BROWSING venues
   (open the pages — evidence rules apply): the Quanta Magazine index, SciRate /
   arXiv most-scited, one or two arXiv category listings, a major journal ToC.
   Pick what is everywhere, not what is interesting.
